    ...
    return (
      <div className="row">
        ...
        <div className="col s12 m12 l7">
          <p className="flow-text post-text"
             style={{whiteSpace:"pre-line"}}>{description || 'No Description Available'}</p>
        </div>
          ...
          <div className="featured-post">
            ...
            <div className="card">
              ...
              <div className="card-content">
                ...
                <div className="post-end"><span className="create-date">Bishrant Tandukar</span><span>admin</span></div>
              </div>
