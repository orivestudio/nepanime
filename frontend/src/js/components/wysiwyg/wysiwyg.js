...
class wysiwyg extends Component {
  ...
  convertToJson(e) {
    ...
    let textToDownload = `{"id":,"imageUrl":"${this.state.postImageUrl}","bannerUrl":"${this.state.bannerImageUrl}","categories":[${categories}],"title":"${this.state.title}","user":{"name":"Nepanime","profilePictureUrl":"img/profilethumb.jpg","type":"admin"},"description":\`${this.state.textValue}\`,"date":"${this.refs.date.value}"}`;
